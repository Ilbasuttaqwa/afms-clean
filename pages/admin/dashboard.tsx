    ...
    <TataLetakDasbor>
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <GrafikKehadiran data={[
            { date: 'Sen', present: 45, absent: 5, late: 3 },
            { date: 'Sel', present: 48, absent: 2, late: 1 },
            { date: 'Rab', present: 42, absent: 8, late: 2 },
            { date: 'Kam', present: 47, absent: 3, late: 4 },
            { date: 'Jum', present: 44, absent: 6, late: 2 },
            { date: 'Sab', present: 20, absent: 30, late: 0 },
            { date: 'Min', present: 0, absent: 50, late: 0 }
          ]} />
          <RecentActivities activities={[
            { id: 1, type: 'login', message: 'Admin login ke sistem', timestamp: new Date().toISOString(), user: 'Admin' },
            { id: 2, type: 'attendance', message: 'Karyawan melakukan absensi', timestamp: new Date().toISOString(), user: 'John Doe' },
            { id: 3, type: 'device_sync', message: 'Device fingerprint sync berhasil', timestamp: new Date().toISOString() },
            { id: 4, type: 'employee_added', message: 'Karyawan baru ditambahkan', timestamp: new Date().toISOString(), user: 'Admin' }
          ]} />
        </div>
      </div>
    </TataLetakDasbor>
